                ...
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('user/img/product/product-1.jpg') }}">
                        ...
                        <ul class="product__hover">
                            ...
                            <li><a href="#"><img src="{{ asset('user/img/icon/compare.png') }}" alt=""> <span>Compare</span></a></li>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="instagram__pic">
                    <div class="instagram__pic__item set-bg" data-setbg="{{ asset('user/img/instagram/instagram-1.jpg') }}"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="{{ asset('user/img/instagram/instagram-2.jpg') }}"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="{{ asset('user/img/instagram/instagram-3.jpg') }}"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="{{ asset('user/img/instagram/instagram-4.jpg') }}"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="{{ asset('user/img/instagram/instagram-5.jpg') }}"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="{{ asset('user/img/instagram/instagram-6.jpg') }}"></div>
                </div>
            </div>
            <div class="col-lg-4">
