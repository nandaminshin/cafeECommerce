...
@section('header')
<h4 class="fw-bold pt-3"><span class="text-muted fw-light">Admin /</span> Edit Category</h4>
@endsection
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 offset-xl-3 offset-lg-3 offset-md-3">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" action="{{ route('admin#category_edit_save') }}" method="post">
                        @csrf
