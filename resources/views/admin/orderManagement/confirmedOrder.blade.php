...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="d-flex">
                <h5 class="card-header">Confirmed Order table</h5>
                <div class="mt-3 ms-5">
                    <form action="{{ route('admin#confirmed_order_page') }}" method="get">
                        @csrf
                        <div class="d-flex">
            ...
            <div class="table-responsive text-nowrap">
                @if (!count($data) > 0)
                <div class="alert alert-primary" role="alert">There is no confirmed order here!</div>
                @else
                <table class="table">
                    <thead>
                        <tr>
