                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    <div class="app-brand demo">
                        <a href="{{ route('home') }}" class="app-brand-link">
                            ...
                            <span class="app-brand-text demo menu-text fw-bolder ms-2">ESPRESSO</span>
                        </a>
                    ...
                    <ul class="menu-inner py-1">
                        <!-- Dashboard -->
                        <li class="menu-item @yield('active_dashboard')">
                        ...
                        <!-- Layouts -->
                        <li class="menu-item @yield('active_product1')">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                                <div data-i18n="Account Settings">Manage Products</div>
                            </a>
                            <ul class="menu-sub">
                                <li class="menu-item @yield('active_product2')">
                                    <a href="{{ route('admin#product') }}" class="menu-link">
                                        <div data-i18n="Account">All Products</div>
                                    </a>
                                </li>
                                <li class="menu-item @yield('active_product3')">
                                    <a href="{{ route('admin#create_category') }}" class="menu-link">
                                        <div data-i18n="Notifications" class="d-flex">
                                            Create New Category
                                            <i class="fa-solid fa-plus p-1"></i>
                                        </div>
                                    </a>
                                </li>
                                <li class="menu-item @yield('active_product4')">
                                    <a href="{{ route('admin#create_product') }}" class="menu-link">
                                        <div data-i18n="Connections" class="d-flex">
                                            Create New Prodouct
                                            <i class="fa-solid fa-plus p-1"></i>
                                        </div>
                                    </a>
                        ...
                        <li class="menu-item @yield('active_user1')">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                                <div data-i18n="Account Settings">Manage User</div>
                            </a>
                            <ul class="menu-sub">
                                <li class="menu-item @yield('active_user2')">
                                    <a href="{{ route('admin#admin_management_page', Auth::user()->id) }}" class="menu-link">
                                        <div data-i18n="Account">Admin Management</div>
                                    </a>
                                </li>
