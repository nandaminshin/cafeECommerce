        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pt-2 pb-5">
                <div class="checkout__form">
                    <form id="order-delete-form" method="POST" action="{{ route('user#delete_order', $order->id) }}">
                        @csrf
                        <div class="checkout__order">
                            <h4 class="order__title">Your order</h4>

                            @if ($order->message)
                            <div class="card mt-3 mb-2 align-item-center"
                                style="width: 18rem; background: transparent; border: none;">
                                <img src="{{ asset('admin/assets/img/avatars/sorry.png') }}" class="card-img-top"
                                    alt="...">
                                <div class="card-body">
